...
def main(
    ...
    output: Path | None = typer.Option(
        None,
        "--output",
        help="Output directory for converted files (default: ./<target output dir>)",
    ),
    dest: Path | None = typer.Option(
        None,
        "--dest",
        help="Deploy destination (default: target-global or project-local)",
    ),
) -> None:
    ...
    manifest = install(target_impl, output, resolved_dest)
